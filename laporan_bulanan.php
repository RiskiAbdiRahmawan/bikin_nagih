...
$query = "SELECT * FROM keuangan WHERE DATE_FORMAT(tanggal, '%Y-%m') = '$date'";
...
$queryPemasukan = "SELECT SUM(jumlah) AS totalPemasukan FROM keuangan WHERE DATE_FORMAT(tanggal, '%Y-%m') = '$date' AND jenis_Transaksi = 'pemasukan'";
...
$queryPengeluaran = "SELECT SUM(jumlah) AS totalPengeluaran FROM keuangan WHERE DATE_FORMAT(tanggal, '%Y-%m') = '$date' AND jenis_Transaksi = 'pengeluaran'";
    ...
    <div id="app">
        <div class="flex flex-col md:flex-row">
            ...
            <div class="text-gray-100 flex justify-between md:flex-col min-h-screen w-64" style="background-color: #ff5050;">
                <div class="px-8 py-6">
                    <h1 class="text-2xl font-bold text-black">Laporan Keuangan Bulanan</h1>
                </div>
            ...
            <div class="bg-white w-full">
                <div class="container mx-auto px-4 py-6">
                    <h1 class="text-2xl font-bold mb-6">Laporan Keuangan Bulanan</h1>
                    <form method="GET" action="" class="mb-6">
                        <label for="date" class="block">Pilih Bulan dan Tahun:</label>
                        <input type="month" id="date" name="date" value="<?php echo $date; ?>" class="border border-gray-300 rounded px-4 py-2 focus:outline-none focus:border-blue-500">
